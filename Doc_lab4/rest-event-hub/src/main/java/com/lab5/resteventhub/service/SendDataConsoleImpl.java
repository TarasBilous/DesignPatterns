...
public class SendDataConsoleImpl implements SendDataService {
    ...
    private static final String CACHE_HOSTNAME = "redisCacheB.redis.cache.windows.net";
    private static final String CACHE_KEY = "lWrUaVI6Eb5ha5En+lv6O+e0CtjY8+syTwdgCFucAg8=";
    private final static String MAP_NAME = "lab4";
